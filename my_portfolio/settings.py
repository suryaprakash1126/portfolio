...
SECRET_KEY = 'django-insecure-f&t@$jic0ql50d-#*zak$s*@g&*kya(&eu+!ga5j29cdcjbu-7'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # input folder
